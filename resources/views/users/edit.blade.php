                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="home_no" type="text" maxlength="5" class="form-control @error('home_no') is-invalid @enderror" name="address[home_no]" value="{{$user?->address?->house_no}}" required autocomplete="home_no" autofocus>
