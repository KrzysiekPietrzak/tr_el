                        ...
                        <div class="row mb-3">
                           ...
                           <div class="col-md-6">
                            ...
                            <label for="amount" class="col-md-4 col-form-label text-md-end">Ilość</label>
                                                                                               ...
                                                                                               <div class="col-md-6">
                                                                                                    <input id="amount" type="number" min="0" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{ old('amount') }}" required autocomplete="phonenumber" autofocus>
